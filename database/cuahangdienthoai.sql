...
(5, 'Samsung Galaxy J7+', 'Samsung Galaxy J7+ là dòng smartphone tầm trung nhưng được trang bị camera kép có khả năng chụp ảnh xóa phông chân dung cùng thiết kế đẹp và hiệu năng mạnh mẽ.\r\nThiết kế cao cấp\r\n\r\nSamsung Galaxy J7+ tiếp tục được sử dụng thiết kế nguyên khối từ kim loại như các dòng cao cấp, mang lại vẻ đẹp sang trọng cũng như bền bỉ nhất.', 9000000, 7500000, 10, 'SAMSUNG', 'imgDT/j7+.png'),
...
(20, 'Xiaomi Mi A1 64GB', 'Mi A1 được Xiaomi chính thức ra mắt tại Ấn Độ với vai trò là một dự án hợp tác Android One của Google. Hãy cùng mình trên tay nhanh chiếc máy chạy Android thuần cùng camera xóa phông ảo diệu mà giá chỉ hơn 5 triệu này nhé.', 5700000, 5450000, NULL, 'XIAOMI', 'imgDT/xi1.png'),
